...
MODULE_INFO(depends, "snd-hda-codec,snd-hda-core,snd,snd-pcm,snd-intel-dspcfg");
...
MODULE_ALIAS("pci:v00008086d0000A828sv*sd*bc*sc*i*");
...
MODULE_ALIAS("pci:v00006766d*sv*sd*bc04sc03i00*");
