...
deps_drivers/thermal/intel/intel_hfi.o := \
  ...
  drivers/thermal/intel/../thermal_netlink.h \
    $(wildcard include/config/THERMAL_NETLINK) \

drivers/thermal/intel/intel_hfi.o: $(deps_drivers/thermal/intel/intel_hfi.o)
